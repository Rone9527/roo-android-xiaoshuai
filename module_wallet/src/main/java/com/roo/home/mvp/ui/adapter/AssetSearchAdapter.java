...
public class AssetSearchAdapter extends BaseQuickAdapter<LinkTokenBean.TokensBean, BaseViewHolderImpl> {
    private ArrayList<String> tokenMap;

    @Inject
    public AssetSearchAdapter() {
        super(R.layout.item_asset_search);
    ...
    protected void convert(BaseViewHolderImpl helper, LinkTokenBean.TokensBean item) {
        ...
        helper.setText(R.id.tvLink, MessageFormat.format("({0} Token)", item.getChainCode()));
