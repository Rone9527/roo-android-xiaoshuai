...
@ActivityScope
public class WalletCreatePresenter extends BasePresenter<WalletCreateContract.Model, WalletCreateContract.View> {

    @Inject
    RxErrorHandler mErrorHandler;

    @Inject
    public WalletCreatePresenter(WalletCreateContract.Model model, WalletCreateContract.View rootView) {
