...
public abstract class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (divider.getLeftSideLine().isHave()) {
                int lineWidthPx = Kits.Dimens.pxToDpCeilInt(context, divider.getLeftSideLine().getWidthDp());
                int startPaddingPx = Kits.Dimens.pxToDpCeilInt(context, divider.getLeftSideLine().getStartPaddingDp());
                int endPaddingPx = Kits.Dimens.pxToDpCeilInt(context, divider.getLeftSideLine().getEndPaddingDp());
            ...
            if (divider.getTopSideLine().isHave()) {
                int lineWidthPx = Kits.Dimens.pxToDpCeilInt(context, divider.getTopSideLine().getWidthDp());
                int startPaddingPx = Kits.Dimens.pxToDpCeilInt(context, divider.getTopSideLine().getStartPaddingDp());
                int endPaddingPx = Kits.Dimens.pxToDpCeilInt(context, divider.getTopSideLine().getEndPaddingDp());
            ...
            if (divider.getRightSideLine().isHave()) {
                int lineWidthPx = Kits.Dimens.pxToDpCeilInt(context, divider.getRightSideLine().getWidthDp());
                int startPaddingPx = Kits.Dimens.pxToDpCeilInt(context, divider.getRightSideLine().getStartPaddingDp());
                int endPaddingPx = Kits.Dimens.pxToDpCeilInt(context, divider.getRightSideLine().getEndPaddingDp());
            ...
            if (divider.getBottomSideLine().isHave()) {
                int lineWidthPx = Kits.Dimens.pxToDpCeilInt(context, divider.getBottomSideLine().getWidthDp());
                int startPaddingPx = Kits.Dimens.pxToDpCeilInt(context, divider.getBottomSideLine().getStartPaddingDp());
                int endPaddingPx = Kits.Dimens.pxToDpCeilInt(context, divider.getBottomSideLine().getEndPaddingDp());
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        int left = divider.getLeftSideLine().isHave() ? Kits.Dimens.pxToDpCeilInt(context, divider.getLeftSideLine().getWidthDp()) : 0;
        int top = divider.getTopSideLine().isHave() ? Kits.Dimens.pxToDpCeilInt(context, divider.getTopSideLine().getWidthDp()) : 0;
        int right = divider.getRightSideLine().isHave() ? Kits.Dimens.pxToDpCeilInt(context, divider.getRightSideLine().getWidthDp()) : 0;
        int bottom = divider.getBottomSideLine().isHave() ? Kits.Dimens.pxToDpCeilInt(context, divider.getBottomSideLine().getWidthDp()) : 0;
...
//                //itemPosition时条目的分割线情况，有无、颜色、宽度、startpadding 和 endpadding
//                int type = adapter.getItemViewType(itemPosition);
//                DividerBuilder dividerBuilder = new DividerBuilder();
//                if (type == ForumsAdapter.TYPE_FORUMS) {
//                    return dividerBuilder
//                            .setTopSideLine(true, 0xAAEBEBEB, 10, 0, 0)
//                            .setBottomSideLine(true, 0xAAEBEBEB, 10, 0, 0)
//                            .create();
//                } else {
//                    return dividerBuilder
//                            .setRightSideLine(true, 0xAAEBEBEB, 10, 0, 0)
//                            .setBottomSideLine(true, 0xAAEBEBEB, 10, 0, 0)
//                            .create();
//                }
//            }
