 ...
 * 转账信息确认弹窗
 */
public class TronTransferDappConfirmDialog extends FullScreenDialogFragment {
    ...
    public static TronTransferDappConfirmDialog newInstance(String fromAddress,
                                                            String toAddress,
                                                            String amount,
                                                            LinkTokenBean.TokensBean tokensBean
                                                        ) {
        TronTransferDappConfirmDialog fragment = new TronTransferDappConfirmDialog();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View inflate = inflater.inflate(R.layout.dialog_transfer_dapp_confirm_tron, container, false);
        ...
        tvTransferCountUnit.setText("TRX");
    ...
    public TronTransferDappConfirmDialog setOnEnsureClickedListener(OnEnsureClickedListener onEnsureClickedListener) {
