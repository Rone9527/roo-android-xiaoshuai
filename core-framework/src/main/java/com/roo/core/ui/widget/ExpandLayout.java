...
/**
 * blog  : https://github.com/yangchong211/YCExpandView
 * desc  : 自定义折叠布局
 */
public class ExpandLayout extends LinearLayout {
    ...
    private void setViewDimensions(final int expandHeight) {
        ...
        layoutView.post(() -> {
            ...
            LogManage.d("获取内容布局" + viewHeight + "-----" + expandHeight + "----" + measuredHeight);
    ...
    private void animateToggle(long animationDuration) {
        ...
        clearAnim();
        if (isExpand) {
            LogManage.d("切换动画实现" + viewHeight + "-----" + expandHeight + "----折叠");
            animation = ValueAnimator.ofFloat(expandHeight, viewHeight);
        } else {
            LogManage.d("切换动画实现" + viewHeight + "-----" + expandHeight + "----展开");
        ...
        animation.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                LogManage.d("onAnimationUpdate----" + "-----" + value);
