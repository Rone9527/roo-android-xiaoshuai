 ...
 * 转账信息确认弹窗
 */
public class TransferConfirmDialog extends FullScreenDialogFragment {
    ...
    public static TransferConfirmDialog newInstance(String fromAddress, String toAddress,
                                                    String amount, LinkTokenBean.TokensBean tokensBean, BigDecimal gas) {
        TransferConfirmDialog fragment = new TransferConfirmDialog();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View inflate = inflater.inflate(R.layout.dialog_transfer_confirm, container, false);
        ...
        TextView tvGasFee = inflate.findViewById(R.id.tvGasFee);
    ...
    public TransferConfirmDialog setOnEnsureClickedListener(OnEnsureClickedListener onEnsureClickedListener) {
