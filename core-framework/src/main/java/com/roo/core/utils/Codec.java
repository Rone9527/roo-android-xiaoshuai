...
public class Codec {
    ...
    @StringDef({Algorithm.SHA, Algorithm.MD5, Algorithm.Hmac_MD5, Algorithm.Hmac_SHA1, Algorithm.Hmac_SHA256, Algorithm.Hmac_SHA384, Algorithm.Hmac_SHA512,
            Algorithm.DES, Algorithm.RSA})
    ...
    public static class MD5 {
        ...
        public static String getMessageDigest(byte[] buffer) {
            ...
            try {
                MessageDigest mdTemp = MessageDigest.getInstance(Algorithm.MD5);
    ...
    public static class SHA {
        ...
        public static byte[] encrypt(byte[] data) throws Exception {
            MessageDigest sha = MessageDigest.getInstance(Algorithm.SHA);
            sha.update(data);
            return sha.digest();
        }
    ...
    public static class MAC {
         ...
         * @throws Exception
         */
        public static String initMacKey(@Algorithm String algorithm) throws Exception {
            if (algorithm == null) {
         ...
         * @throws Exception
         */
        public static byte[] encrypt(byte[] plain, String key, @Algorithm String algorithm) throws Exception {
            if (algorithm == null) {
                algorithm = Algorithm.Hmac_MD5;
            }
    ...
    public static class DES {
        ...
        public static String initKey(String seed) throws Exception {
            ...
            KeyGenerator kg = KeyGenerator.getInstance(Algorithm.DES);
    ...
    public static class RSA {
        ...
        public static String sign(byte[] data, String privateKey) throws Exception {
            ...
            KeyFactory keyFactory = KeyFactory.getInstance(Algorithm.RSA);    // KEY_ALGORITHM 指定的加密算法
