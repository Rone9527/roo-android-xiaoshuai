 ...
 *     time   : 2017/08/18
 *     desc   : 根据需求，对图片定制指定的圆角[如果需要centerCrop属性 请使用{@link TransformRoundCornersCenterCrop}]
 * </pre>
 */

public class TransformRoundCorners implements Transformation<Bitmap> {
    /**
     * 所有角
     */
    ...
    public TransformRoundCorners(Context context, int radius, @CornerType int type) {
        this(context, radius, type, 0);
    }

    public TransformRoundCorners(Context context, int radius, @CornerType int type, int colorRes) {
