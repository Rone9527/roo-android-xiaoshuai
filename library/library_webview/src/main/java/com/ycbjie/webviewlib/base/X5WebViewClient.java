...
import com.ycbjie.webviewlib.utils.DVDUrlCache;
 ...
 *
 *             读取缓存并拦截请求：https://blog.csdn.net/dodod2012/article/details/88868930
 * </pre>
 */
public class X5WebViewClient extends WebViewClient {
    ...
    public X5WebViewClient(WebView webView, Context context) {
        ...
        dvdUrlCache = new DVDUrlCache(context);
        //将js对象与java对象进行映射
...
//        return super.shouldInterceptRequest(webView, s);
        return WebViewCacheInterceptorInst.getInstance().interceptRequest(s);
    }
...
//        X5LogUtils.i("---shouldInterceptRequest-------->21---"+method + "----" +webResourceRequest.getUrl()+super.shouldInterceptRequest(webView, webResourceRequest));
...
//                isType = "image/jpg";
//
//            } else if (url.lastIndexOf(".jpeg") != -1) {
//                isType = "image/jpeg";
//
//            } else if (url.lastIndexOf(".otf") != -1) {
//                isType = "application/x-font-otf";
//
//            } else if (url.lastIndexOf(".ttf") != -1) {
//                isType = "application/x-font-ttf";
//
//            } else if (url.lastIndexOf(".ttc") != -1) {
//                isType = "application/x-font-ttf";
//
//            } else if (url.lastIndexOf(".svg") != -1) {
//                isType = "image/svg+xml";
