...
public class KLineChartView extends BaseKLineChartView {
    ...
    public VolumeDraw getVolumeDraw() {
        return mVolumeDraw;
    }
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        if (array != null) {
            try {
                ...
                setSelectedXLineColor(Color.parseColor("#6995A2"));
                ...
                setMa50Color(array.getColor(R.styleable.KLineChartView_kc_macd_color, getColor(R.color.chart_ma50)));
    ...
    public void setValueFormatter(IValueFormatter valueFormatter) {
        super.setValueFormatter(valueFormatter);
        if (mMainDraw != null) {
            mMainDraw.setValueFormatter(valueFormatter);
        }
    }
