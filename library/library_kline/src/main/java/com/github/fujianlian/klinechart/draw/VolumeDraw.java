...
public class VolumeDraw implements IChartDraw<IVolume> {
    ...
    public VolumeDraw(BaseKLineChartView view) {
        ...
        int increaseColor = ContextCompat.getColor(context, R.color.chart_red);
        int decreaseColor = ContextCompat.getColor(context, R.color.chart_green);

        mRedPaint.setColor(increaseColor);
        mGreenPaint.setColor(decreaseColor);
