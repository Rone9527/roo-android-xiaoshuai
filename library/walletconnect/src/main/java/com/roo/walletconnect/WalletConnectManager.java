...
import com.roo.walletconnect.log.WCLogUtil;
...
public class WalletConnectManager {
    ...
    public void approveSession(String ethAddress,Long mainChainId) {
        if (null == session) {
            return;
        }
    ...
    public void updateSession(String ethAddress,Long mainChainId) {
        if (null == session) {
            return;
        }
