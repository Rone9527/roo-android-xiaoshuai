...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTextsizeUnselect = ta.getDimension(R.styleable.CommonTabLayout_tl_textsizeUnselect, sp2px(13f));
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            if (mIconGravity == Gravity.LEFT || mIconGravity == Gravity.START) {
                tabView = View.inflate(mContext, R.layout.layout_tab_left, null);
            } else if (mIconGravity == Gravity.RIGHT || mIconGravity == Gravity.END) {
    ...
    private void addTab(final int position, View tabView) {
        ...
        tvTabTitle.setText(mTabEntitys.get(position).getTabTitle());
        ImageView ivTabIcon = tabView.findViewById(R.id.iv_tab_icon);
        ivTabIcon.setImageResource(mTabEntitys.get(position).getTabUnselectedIcon());
    ...
    private void updateTabStyles() {
        for (int i = 0; i < mTabCount; i++) {
            ...
            tvTabTitle.setTextSize(TypedValue.COMPLEX_UNIT_PX, i == mCurrentTab ? mTextsize : mTextsizeUnselect);
            if (mTextAllCaps) {
            ...
            if (mIconVisible) {
                ...
                ivTabIcon.setImageResource(i == mCurrentTab ? tabEntity.getTabSelectedIcon() : tabEntity.getTabUnselectedIcon());
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            tvTabTitle.setTextSize(TypedValue.COMPLEX_UNIT_PX, isSelect ? mTextsize : mTextsizeUnselect);

            ImageView ivTabIcon = tabView.findViewById(R.id.iv_tab_icon);
            CustomTabEntity tabEntity = mTabEntitys.get(i);
            ivTabIcon.setImageResource(isSelect ? tabEntity.getTabSelectedIcon() : tabEntity.getTabUnselectedIcon());
            if (mTextBold == TEXT_BOLD_WHEN_SELECT) {
                tvTabTitle.getPaint().setFakeBoldText(isSelect);
            }
        }
    }
    ...
    public float getTextsizeUnselect() {
        return mTextsizeUnselect;
    }

    public void setTextsizeUnselect(float textsize) {
        this.mTextsizeUnselect = sp2px(textsize);
        updateTabStyles();
    }
    ...
    public TextView getTitleView(int tab) {
        return mTabsContainer.getChildAt(tab).findViewById(R.id.tv_tab_title);
    }
    ...
    public MsgView getMsgView(int position) {
        ...
        return mTabsContainer.getChildAt(position).findViewById(R.id.rtv_msg_tip);
    }
