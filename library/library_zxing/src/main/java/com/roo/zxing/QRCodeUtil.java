...
public class QRCodeUtil {
    ...
    public static Bitmap createQRCodeBitmap(String content, int size, int margin) {
        return createQRCodeBitmap(content, size, "UTF-8", "H", String.valueOf(margin), Color.BLACK, Color.WHITE, null, null, 0F);
    }
     ...
     * @return
     */
    public static Bitmap createQRCodeBitmap(String content, int size, @ColorInt int color_black, @ColorInt int color_white) {
        return createQRCodeBitmap(content, size, "UTF-8", "H", "0", color_black, color_white, null, null, 0F);
    }
    ...
    public static Bitmap createQRCodeBitmap(String content, int size, Bitmap logoBitmap, float logoPercent) {
        return createQRCodeBitmap(content, size, "UTF-8", "H", "0", Color.BLACK, Color.WHITE, null, logoBitmap, logoPercent);
    }
    ...
    public static Bitmap createQRCodeBitmap(String content, int size, Bitmap targetBitmap) {
        return createQRCodeBitmap(content, size, "UTF-8", "H", "0", Color.BLACK, Color.WHITE, targetBitmap, null, 0F);
    }
     ...
     * @param content          字符串内容
     * @param size             位图宽&高(单位:px)
     * @param characterSet    字符集/字符转码格式 (支持格式:{@linkCharacterSetECI })。传null时,zxing源码默认使用 "ISO-8859-1"
     ...
     */
    public static Bitmap createQRCodeBitmap(String content, int size,
                                                             String characterSet, String error_correction, String margin,
        ...
        try {
            ...
            Hashtable<EncodeHintType, Object> hints = new java.util.Hashtable<>();
            ...
            if (!TextUtils.isEmpty(margin)) {
                hints.put(EncodeHintType.MARGIN, Integer.parseInt(margin)); // 空白边距设置
            }
