...
import com.roo.dapp.mvp.interfaces.OnGetBalanceListener;
...
import com.roo.dapp.mvp.interfaces.OnVerifyListener;
...
import com.roo.dapp.mvp.utils.SignCallbackJSInterface;
...
public class Web3View extends WebView {
    ...
    private void callbackToJS(long callbackId, String function, String param) {
        ...
        post(() -> evaluateJavascript(callback, value -> {
        }));
    }
    ...
    private class WrapWebViewClient extends WebViewClient {
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            if (!internalClient.didInjection()) {
                internalClient.injectScriptFile(view);
            }
